...
5. Add frontend Canvas types/services and connect settings, courses, freshness, sync diagnostics, and assignment filters to live APIs while preserving demo mode and the existing design system.
